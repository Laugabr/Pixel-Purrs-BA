...
()
    {
        if (Input.GetButtonDown("Jump")) //si presionamos el salto se crea un contador, dentro de ese tiempo, cuando toques el piso, saltas
        {
    ...
    public virtual void Dash()
    {
        ...
        if (dashInput && canDash) //si tocas el boton de dash ("x")
        {
            ...
            if (_dashingDir == new Vector2(0,0)) //si lo tocas mientras no insertas ningun input, depende de que a que direccion estas viendo
            {
